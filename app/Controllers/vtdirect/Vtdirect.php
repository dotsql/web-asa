...
namespace Codenom\MidtransSampleData\Controllers\Vtdirect;
...
class Vtdirect extends Controller
{
    ...
    {
        return $this->render->setData(['clientKey' => $this->config->clientKey])->render('Codenom\MidtransSampleData\Views\Vtdirect\checkout');
    }
    ...
    public function token()
    {
        ...
        try {
            $response = $this->veritrans->vtWebDirectCharge($transaction_data);
        } catch (\Exception $e) {
            echo $e->getMessage();
        }
