...
class Website extends BaseController
{
   ...
   public function search()
   {
      ...
      $d['aplikasi'] = $this->Maplikasi->data();
      $app = $d['aplikasi']->getrow();
      $d['title'] = "Cari Artikel";
      $d['ogtitle'] = "Cari Artikel";
      $d['ogdescription'] = $app->deskripsi_app;
      $d['ogimage'] = base_url($app->logo_app);
      $d['menu'] = $this->Mmenu->dataparent();
      $d['kelas'] = $this->Mkelas->data();
      ...
      //   $d['getka']= $kategori;
      $d['allartikel'] = $this->Martikel->datatampilsearch($this->request->getpostget('q'));
      $d['artikel'] = $this->Martikel->datafiltersearch($this->request->getpostget('q'), $show, $page);
      $d['kategori'] = $this->Mkategori->data();
      $d['popular'] = $this->Martikel->datapopularlimit(3);
      return Template::website('website/artikel/search', $d);
   }
