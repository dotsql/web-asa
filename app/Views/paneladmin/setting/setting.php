      ...
      <div class="card-box">
         ...
         <div class="tab-content">
            ...
            <div class="tab-pane" id="statistik">
               <div class="form-group">
                  <label>Jumlah Staff & Guru</label>
                  <input type="number" class="form-control" name="staff_app" value="<?php echo $r->staff_app ?>">
               </div>
               <div class="form-group">
                  <label>Jumlah Siswa</label>
                  <input type="number" class="form-control" name="siswa_app" value="<?php echo $r->siswa_app ?>">
               </div>
               <div class="form-group">
                  <label>Jumlah Kejuaraan</label>
                  <input type="number" class="form-control" name="juara_app" value="<?php echo $r->juara_app ?>">
               </div>
               <div class="form-group">
                  <label>Jumlah Kelas</label>
                  <input type="number" class="form-control" name="kelas_app" value="<?php echo $r->kelas_app ?>">
               </div>
            </div>
         </div>
