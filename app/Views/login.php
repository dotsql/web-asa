...
<head>
    ...
    <meta content="Cahyadi Wibisono" name="author">
    ...
    <!-- App css -->
    <link href="<?php echo base_url(); ?>/css/bootstrap.min.css" rel="stylesheet" type="text/css" id="bootstrap-stylesheet">
    <link href="<?php echo base_url(); ?>/css/icons.min.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url(); ?>/css/app.min.css" rel="stylesheet" type="text/css" id="app-stylesheet">
    <!-- Izi Alert-->
    ...
    <?php if (session()->getflashdata('msg') == 'gagal') { ?>
        <script>
            iziToast.show({
                timeout: 5000,
                color: 'red',
                title: 'Gagal! Username Atau Password Salah',
                position: 'topRight',
                pauseOnHover: true,
                transitionIn: false
            });
